...
<body>
    ...
    @endif
    <form class="row mx-3" action="{{ route('store') }}" method="post">
        @csrf
        <div class="mb-3">
        ...
        <div class="form-check">
            ...
            <div class="form-check">
                ...
                <input class="form-check-input" type="radio" value="0" name="risk" id="no" checked>
            </div>


        </div>
        <button type="submit" class="btn btn-dark">Them</button>
    </form>
